...
def Ingest():
    ...
    reader = SimpleDirectoryReader(input_dir="./llamaindex-docs", recursive=True, file_extractor={'.html': UnstructuredReader(), '.pdf': UnstructuredReader(), '.txt': UnstructuredReader()})
